...
% Importiert das Hintergrundbild und zeigt es in der eingestellten Größe an.
bg = imread('Wetter.jpg'); imagesc(bg);
% Verhindert das der Hintergrund übergeplottet wird und entfernt parallel die Achsen. 
