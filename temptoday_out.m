...
% Auslesen der aktuellen Temperatur, Bestimmung der Position des Bildes
axis off
axes ('Position', [0.075 0.65 0.05 0.18])
...
tempaktuell = uicontrol('Style', 'text', 'Units','normalized','Position',...
                        [0.18 0.73 0.1 0.05],'FontSize',16, 'String',...
                        aktuell1);
...
axis off
axes ('Position', [0.545 0.65 0.05 0.18])
...
tempmin = uicontrol('Style', 'text', 'Units','normalized','Position',...
                   [0.65 0.65 0.1 0.05],'FontSize',16,'String',...
                   aktuell2);
...
tempmax = uicontrol('Style', 'text', 'Units','normalized','Position',...
                   [0.65 0.78 0.1 0.05],'FontSize',16, 'String', ...
                   aktuell3);
